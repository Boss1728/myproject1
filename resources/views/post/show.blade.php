                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Brand </th><td> {{ $post->brand }} </td></tr><tr><th> Serie </th><td> {{ $post->serie }} </td></tr><tr><th> Color </th><td> {{ $post->color }} </td></tr><tr><th> Year </th><td> {{ $post->year }} </td></tr><tr><th> Mileage </th><td> {{ $post->mileage }} </td></tr><tr><th> User Id </th><td> {{ $post->user_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
